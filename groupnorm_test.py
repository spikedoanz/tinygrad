...
def test_groupnorm(b,c1,c2,N):
  ...
  for backend in [BACKEND1, BACKEND2]:
    ...
    #gn = nn.BatchNorm(c2, c2, affine=False)
...
print("="*80)
#b,c1,c2,N = [30,5,5,128+36] # channels [5,10,15,30] break
#test_groupnorm(b,c1,c2,N)
#b,c1,c2,N = [21,5,5,128+36] # channels [5,10,15,30] break
#test_groupnorm(b,c1,c2,N)
#b,c1,c2,N = [16,5,5,128+36] # channels [5,10,15,30] break
#test_groupnorm(b,c1,c2,N)
